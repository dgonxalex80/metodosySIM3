...
* El intervalo de confianza para la pendiente $\beta_{1}$ se puede interpretar como: Por cada unidad aducional (cm) en el diámetro del árbol, la cantidad de biomasa total estimada aumenta entre 4.6 y 5.6 ton con una confianza del 95% 
